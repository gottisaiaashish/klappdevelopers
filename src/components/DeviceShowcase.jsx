            ...
            <div className="macbook-window">
              ...
              <div className="macbook-body">
                <div style={{ background: '#f4f1ea', padding: '16px', borderRadius: '10px', marginBottom: '14px', border: '1px solid var(--border-color)' }}>
                  <div style={{ fontFamily: 'var(--font-serif)', fontSize: '1.2rem', fontWeight: '600', color: 'var(--text-primary)' }}>Nandhakam Luxury Stays & Resort</div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '14px' }}>
                  <div style={{ background: '#faf8f5', padding: '12px', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                    ...
                    <div style={{ fontSize: '1rem', fontWeight: '700', color: '#15803d', marginTop: '2px' }}>Available (8)</div>
                  </div>
                  <div style={{ background: '#faf8f5', padding: '12px', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                    <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>WhatsApp Webhook</div>
                    <div style={{ fontSize: '1rem', fontWeight: '700', color: '#4338ca', marginTop: '2px' }}>Connected</div>
                  </div>
                </div>

                <div style={{ background: '#faf8f5', padding: '18px', borderRadius: '8px', border: '1px dashed var(--border-color)', textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.82rem' }}>
                  <i className="ri-pulse-line" style={{ fontSize: '1.4rem', color: 'var(--accent-dot)', display: 'block', marginBottom: '4px' }}></i>
          ...
          <div className="glass-card" style={{ padding: '24px' }}>
            ...
            <div className="iphone-frame">
              ...
              <div className="notif-card">
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--text-primary)' }}>New Booking Confirmation sent to Client #84109</div>
              </div>
              ...
              <div className="notif-card">
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--text-primary)' }}>Automated PDF invoice parsed & synced to PostgreSQL.</div>
              </div>
              ...
              <div className="notif-card">
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--text-primary)' }}>System health 100%. Uptime SLA 99.99%.</div>
              </div>
            </div>
          </div>
